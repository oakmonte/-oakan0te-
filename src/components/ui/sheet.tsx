...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-[var(--ease-smooth-out)] data-[state=closed]:duration-[var(--duration-medium)] data-[state=open]:duration-[var(--duration-slow)] data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
