...
export function DashboardSkeleton() {
  return (
    <div className="flex flex-col gap-8 px-4 pb-[calc(env(safe-area-inset-bottom)+2.5rem)] pt-5">
      {/* The announcement sits OUTSIDE the aria-hidden part. It used to be
          inside an aria-hidden root, which hid it from screen readers too, so
          "Loading your store" was never announced. */}
