...
export function OnboardingChecking() {
  return (
    <div className="min-h-dvh bg-brand-bg text-brand-text flex flex-col items-center justify-center px-6 text-center">
      <p className="font-loading-display font-semibold text-2xl sm:text-3xl leading-tight text-brand-text/90 max-w-xs">
        {LOADING_LINE}
      </p>
      <span className="mt-3 text-xs text-brand-text/40 font-normal tracking-wide">loading…..</span>
    </div>
  );
}
