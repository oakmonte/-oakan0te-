      ...
      <main className="flex-1 flex items-center justify-center px-6 py-10">
        <div className="w-full max-w-sm">
          <div className="text-center mb-10">
            ...
            <p className="mt-3 text-sm text-brand-text/70">{subtitle}</p>
          </div>
          ...
          {notice && <p className="mb-4 text-xs text-brand-text/60 text-center">{notice}</p>}
          ...
          {mode === "password" ? (
            <form onSubmit={handlePasswordSignIn} className="space-y-3">
              ...
              <button
                ...
                className="w-full text-[11px] uppercase tracking-widest text-brand-text/60 hover:text-brand-text transition-colors pt-2"
              >
            ...
            <div className="text-center space-y-4">
              <div className="rounded-2xl border border-brand-text/15 px-6 py-8">
                ...
                <p className="mt-2 text-sm text-brand-text/70">
                  We sent a 6-digit code to <span className="text-brand-text">{email}</span>. It
              ...
              <div className="text-sm text-brand-text/70">
                {countdown > 0 ? (
                  ...
                  <button
                    ...
                    disabled={busy === "send"}
                    className="text-brand-accent uppercase tracking-widest text-[11px] font-medium hover:underline disabled:opacity-60"
                  >
                    Resend code
                  </button>
                )}
