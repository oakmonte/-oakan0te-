...
export function TopToggleNav({ active, onChange, onWalletClick, onSearchClick, searchIcon }: TopToggleNavProps) {
  return (
    <div className="flex items-center justify-between" style={{ width: 358 }}>
      ...
      >
        <span
          ...
          style={{ width: 102, height: 41, top: 6, left: active === "shop" ? 2 : 104, background: "#EDEDED" }}
        />
        <button
      ...
      <div className="flex items-center gap-4" style={{ width: 102 }}>
        <button
          ...
          style={{
            width: 37, height: 35, background: "rgba(255,255,255,0.65)",
            boxShadow: "0px 8px 40px rgba(0,0,0,0.12)",
