...
function Index() {
  ...
  const typeText = "Oakmonte is an ecosystem designed for those who expect more. We connect vetted sellers, honest creators and style curators through a content optimised marketplace.";
