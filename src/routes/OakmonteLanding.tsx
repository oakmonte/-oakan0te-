...
.oak .hero-tagline{font-size:22px;line-height:1.4;color:var(--black);max-width:36rem;margin:-24px 0 40px;font-weight:900;opacity:0;animation:oakFadeUp .7s ease forwards;animation-delay:.65s;}
